...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} login [provider]          Connect an October account, another provider, or an API key
...
${chalk.bold("Options:")}
  ...
  --resume, -r [id]              Select a session to resume, or open id/path/prefix directly
...
${chalk.bold("Environment Variables:")}
  ...
  PI_SHARE_VIEWER_URL              - Base URL for /share command (default: https://www.october.dev/session/)
  OCTOBER_CATALOG_BASE_URL         - Optional remote catalog overlay (unset = disabled)
