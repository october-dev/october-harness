...
const OFFICIAL_PACKAGE_NAME = "@october-dev/october";
const OFFICIAL_APP_NAME = "october";
const OFFICIAL_CONFIG_DIR_NAME = ".october";
 ...
 * - this is the official October distribution (not a further fork/rebrand)
