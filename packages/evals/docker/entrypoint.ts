...
function assertWorkspace(): void {
	...
	const codingAgentDir = "/repo/node_modules/@october-dev/october";
...
const codingAgentEntry = fileURLToPath(import.meta.resolve("@october-dev/october"));
if (codingAgentEntry !== "/repo/node_modules/@october-dev/october/dist/index.js") {
...
process.env.OCTOBER_CODING_AGENT_DIR = agentDir;
